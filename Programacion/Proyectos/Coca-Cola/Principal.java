...
public class Principal extends JFrame implements ActionListener{
  ...
  public Principal(){
    ...
    labelDepartamento = new JLabel("Selecciona del departamento");
    ...
    labelAntiguedad = new JLabel("Selecciona del departamento");
    ...
    public void actionPerformed(ActionEvent evento){
      ...
      if(evento.getSource() == miElCreador){
        ...
        JOptionPane.showMessageDialog(null, "Desarrollado por Demián Baqué");
      }
